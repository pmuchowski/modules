...
public abstract class AbstractPatientAdapterIT {
    ...
    public void shouldUpdatePatient() throws InterruptedException {
        ...
        OpenMRSPatient patient = patientAdapter.getPatientByMotechId("750");
        ...
        OpenMRSPatient fetched = patientAdapter.getPatientByMotechId("750");
    ...
    public void shouldSearchForPatient() {
        List<OpenMRSPatient> found = patientAdapter.search("Bill", null);

        assertEquals(asList("Bill"), extract(found, on(OpenMRSPatient.class).getPerson().getFirstName()));
    }
    ...
    public class MrsListener implements EventListener {
        ...
        @MotechListener(subjects = {EventKeys.CREATED_NEW_PATIENT_SUBJECT, EventKeys.UPDATED_PATIENT_SUBJECT,
            EventKeys.PATIENT_DECEASED_SUBJECT, EventKeys.DELETED_PATIENT_SUBJECT})
